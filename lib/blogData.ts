...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: 'Tìm hiểu sự khác biệt cơ bản giữa rượu vang đỏ và vang trắng, từ quy trình sản xuất đến hương vị đặc trưng.',
    content: '',
  ...
  },
  {
    ...
    excerpt: 'Khám phá 5 bước cơ bản để thưởng thức rượu vang đúng cách: quan sát, ngửi, nếm, đánh giá và tận hưởng.',
    content: '',
  ...
  },
  {
    ...
    excerpt: 'Bí quyết kết hợp rượu vang với các món ăn để tạo nên trải nghiệm ẩm thực hoàn hảo.',
    content: '',
  ...
  },
  {
    ...
    excerpt: 'Hướng dẫn chi tiết về nhiệt độ, độ ẩm và vị trí lý tưởng để bảo quản rượu vang lâu dài.',
    content: '',
  ...
  },
  {
    ...
    excerpt: 'Hành trình qua Bordeaux, Burgundy, Champagne và những vùng sản xuất rượu vang danh tiếng nhất nước Pháp.',
    content: '',
  ...
  },
  {
    ...
    excerpt: 'Tìm hiểu về sự đa dạng của rượu vang Ý từ Tuscany đến Piedmont, Veneto và Sicily.',
    content: '',
  ...
  },
  {
    ...
    excerpt: 'Hướng dẫn chi tiết về nhiệt độ phục vụ tối ưu cho từng loại rượu vang để tận hưởng trọn vẹn hương vị.',
    content: '',
    image: '/wines/wine-1.jpg',
    category: 'tasting',
    categoryLabel: 'Thưởng thức',
  ...
  },
  {
    ...
    excerpt: 'Tầm quan trọng của việc chọn ly rượu đúng cách và ảnh hưởng của nó đến trải nghiệm thưởng thức.',
    content: '',
    image: '/wines/wine-2.jpg',
    category: 'education',
    categoryLabel: 'Kiến thức',
  ...
  },
  {
    ...
    excerpt: 'Tìm hiểu về rượu vang hữu cơ và biodynamic, quy trình sản xuất bền vững và lợi ích cho sức khỏe.',
    content: '',
    image: '/wines/wine-3.jpg',
    category: 'education',
    categoryLabel: 'Kiến thức',
