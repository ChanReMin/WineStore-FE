...
export default function RejectWarehouseModal({
  warehouse,
  isOpen,
  onClose,
  onSuccess,
}: RejectWarehouseModalProps) {
  const t = useTranslations("admin.warehouseApproval.reject");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await rejectWarehouse(warehouse.id, reason);
      onSuccess();
      onClose();
      setReason("");
    } catch (err) {
      ...
      {isOpen && (
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              {/* Header */}
              <div className="bg-linear-to-r from-red-600 to-red-700 p-6 text-white rounded-t-2xl">
              ...
              <form onSubmit={handleSubmit} className="p-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <motion.button
                    ...
                    className="flex-1 px-4 py-2.5 rounded-lg bg-red-600 text-white hover:bg-red-700 transition-colors font-medium disabled:opacity-50 flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      <>
