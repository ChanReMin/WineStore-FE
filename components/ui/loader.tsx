  ...
  return (
    <div className="flex items-center gap-2">
      <motion.div
        ...
        className="h-4 w-4 rounded-full border bg-[#33391d]"
      />
      <motion.div
        initial={{
          y: 0,
  ...
  return (
    <div className="flex items-center">
      <motion.div
        ...
        className="h-4 w-4 rounded-full bg-[#33391d] shadow-md dark:bg-[#33391d]"
      />
      <motion.div
        initial={{
          x: 0,
        ...
        className="h-4 w-4 -translate-x-2 rounded-full bg-[#33391d] shadow-md dark:bg-[#33391d]"
      />
      <motion.div
        initial={{
          x: 0,
